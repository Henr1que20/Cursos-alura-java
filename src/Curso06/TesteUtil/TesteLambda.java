...
public class TesteLambda {
	public static void main(String[] args) {
		...
		//TitularDaContaComparador compararTitula = new TitularDaContaComparador();
		
		//SaldoDaContaComparador comparadorDeSaldo = new SaldoDaContaComparador();
...
class SaldoDaContaComparador implements Comparator<Conta>{
